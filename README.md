...
## **Student 1** — Core Architecture & Data Management
...
## **Student 2** — Advanced Utilities & Concurrency
...
## **Student 3** — GUI Developer & User Interaction

**Role in the App Flow:** This part serves as the entry point and visual interface of the application. It is responsible for capturing user input (task names, deadlines) and displaying the task lists to the user. This student ensures that user actions, such as clicking an "Add Task" button, trigger the appropriate logic in the backend.
